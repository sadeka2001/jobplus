...
@section('content')
    ...
    <section class="site-section">
        <div class="container">
            <div class="row mb-5 justify-content-center">
                <div class="col-md-7 text-center">
                    <h2 class="section-title mb-2">Recent Job Published</h2>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 text-center mt-4 mb-5">
                    <div class="row justify-content-center">
                        <div class="col-md-7">
                            <h2 class="section-title mb-2">Top Company We've Helped</h2>
        ...
        <div class="owl-carousel single-carousel">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 align-self-end text-center text-lg-right">
                        <img src="{{ asset('assets/fronted/images/person_transparent_2.png') }}" alt="Image"
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 align-self-end text-center text-lg-right">
                        <img src="{{ asset('assets/fronted/images/person_transparent.png') }}" alt="Image"
                            class="img-fluid mb-0">
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 ml-auto align-self-end">
                    <img src="{{ asset('assets/fronted/images/apps.png') }}"
