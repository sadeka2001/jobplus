     ...
     <div class="page-heading">
         <div class="row">
             ...
             <div class="col-sm-6 pt-4 text-right">
                 <a href="{{ route('job-post.create') }}" class="btn bg-primary text-white"><i class="fa fa-plus-circle"></i>
                     Add
                     New</a>
                                 ...
                                 @forelse ($job_posts as $key=>$job)
                                     <tr>
                                         ...
                                         <td style="text-align: center" width="12%">
                                             <a href="{{ route('job-post.edit', $job->id) }}"
                                                 class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                                             <form id="delete-form-{{ $job->id }}"
                                                 action="{{ route('job-post.destroy', $job->id) }}" method="POST"
