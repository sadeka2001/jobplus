...
@section('content')
    <div class="page-heading">
        <div class="row">
            ...
            <div class="col-sm-6 pt-4 text-right">
                <a href="{{ route('job-post.index') }}" class="btn bg-danger text-white"><i class="fa fa-reply"></i> Back to
                    list</a>
    ...
    <div class="page-content fade-in-up">
        <div class="ibox rounded">
            <div class="ibox-body">
                <div id="row">
                    <form method="post" action="{{ route('job-post.update', $job->id) }}" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                        @method('put')
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="email" id="email" value="{{ $job-> email}}" class="form-control"
                                                    required>
                                                @error('email')
                                                    <span class="text-danger" role="alert">
                                                        <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="phone" id="phone" value="{{ $job-> phone}}" class="form-control"
                                                    required>
                                                @error('phone')
                                                    <span class="text-danger" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="job_location" id="job_location" value="{{ $job-> job_location}}"
                                                    class="form-control">
                                                @error('job_location')
                                                    <span class="text-danger" role="alert">
                                                        <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-md-6">
                                                <label for="salary">Expected Salary<strong
                                                        class="text-danger">*</strong></label>
                                                <input type="text" name="salary" id="salary" value="{{ $job-> salary}}" class="form-control">
                                                @error('salary')
                                                    <span class="text-danger" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <label for="education">Education<strong
                                                        class="text-danger">*</strong></label>
                                                <input type="text" name="education" id="education" value="{{ $job-> education}}" class="form-control"
                                                    required>
                                                @error('education')
                                                    <span class="text-danger" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                <label for="published_date">Published Date<strong
                                                        class="text-danger">*</strong></label>
                                                <input type="date" name="published_date" id="published_date" value="{{ $job-> published_date}}"
                                            ...
                                            <div class="col-md-6">
                                                <label for="deadline_date">Deadline Date<strong
                                                        class="text-danger">*</strong></label>
                                                <input type="date" name="deadline_date" id="deadline_date" value="{{ $job-> deadline_date}}"
                                                    class="form-control" required>
                                                @error('deadline_date')
                                                    <span class="text-danger" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="company_name" id="company_name"
                                                    class="form-control" value="{{ $job->company_name}}" required>
                                                @error('company_name')
                                                    <span class="text-danger" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="col-md-6">
                                                <label for="company_website">Company Website<strong
                                                        class="text-danger">*</strong></label>
                                                <input type="text" name="company_website" id="company_website" value="{{ $job-> company_website}}"
                                                    class="form-control">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                <label for="twitter_link">twitter link<strong
                                                        class="text-danger">*</strong></label>
                                                <input type="text" name="twitter_link" id="twitter_link" value="{{ $job-> twitter_link}}"
                                                    class="form-control">
                                                @error('twitter_link')
                                                    <span class="text-danger" role="alert">
                                                        <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-md-6">
                                                <label for="fb_link">Fb Link <strong
                                                        class="text-danger">*</strong></label>
                                                <input type="text" name="fb_link" id="fb_link" value="{{ $job-> fb_link}}"
                                                    class="form-control">
                                                @error('fb_link')
                                                    <span class="text-danger" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                <label for="linkdin_link">linkdin_link <strong
                                                        class="text-danger">*</strong></label>
                                                <input type="text" name="linkdin_link" id="linkdin_link" value="{{ $job-> linkdin_link}}"
                                                    class="form-control">
                                                @error('linkdin_link')
                                                    <span class="text-danger" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="form-group">
                                            <label for="job_description">Job Description <strong
                                                    class="text-danger">*</strong></label>
                                            <textarea name="job_description" id="job_description" rows="10" class="form-control editor" required>{{ $job-> job_description ?? old('job_description') }}</textarea>
                                        ...
                                        <div class="form-group">
                                            <label for="company_details">Company Details <strong
                                                    class="text-danger">*</strong></label>
                                            <textarea name="company_details" id="company_details" rows="10" class="form-control editor" required>{{$job-> company_details ??  old('company_details') }}</textarea>
                                        ...
                                        <div class="form-group">
                                            <label for="other_benefit">Company Other Benefiit <strong
                                                    class="text-danger">*</strong></label>
                                            <textarea name="other_benefit" id="other_benefit" rows="10" class="form-control editor" required>{{$job-> other_benefit ??  old('other_benefit') }}</textarea>
                                            @error('other_benefit')
                                                <span class="text-danger" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            data-default-file="{{ isset($job->company_logo) ? asset($job->company_logo) : '' }}"
