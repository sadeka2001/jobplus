    ...
    <div class="page-heading">
        <div class="row">
            ...
            <div class="col-sm-6 pt-4 text-right">
                <a href="{{ route('c-blogs.index') }}" class="btn bg-danger text-white"><i class="fa fa-reply"></i> Back to
                    list</a>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="job_title" id="job_title"
                                                value="{{ $job->job_title }}" class="form-control" required>
                                            @error('job_title')
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="email" id="email"
                                                    value="{{ $job->email }}" class="form-control" required>
                                                @error('email')
                                                    <span class="text-danger" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="phone" id="phone"
                                                    value="{{ $job->phone }}" class="form-control" required>
                                                @error('phone')
                                                    <span class="text-danger" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="experience" id="experience"
                                                    value="{{ $job->experience }}" class="form-control" required>
                                                @error('experience')
                                                    <span class="text-danger" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="education" id="education"
                                                    value="{{ $job->education }}" class="form-control" required>
                                                @error('education')
                                                    <span class="text-danger" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="date" name="published_date" id="published_date"
                                                    value="{{ $job->published_date }}" class="form-control" required>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="date" name="deadline_date" id="deadline_date"
                                                    value="{{ $job->deadline_date }}" class="form-control" required>
                                                @error('deadline_date')
                                                    <span class="text-danger" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="twitter_link" id="twitter_link"
                                                    value="{{ $job->twitter_link }}" class="form-control">
                                                @error('twitter_link')
                                                    <span class="text-danger" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="fb_link" id="fb_link"
                                                    value="{{ $job->fb_link }}" class="form-control">
                                                @error('fb_link')
                                                    <span class="text-danger" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="linkdin_link" id="linkdin_link"
                                                    value="{{ $job->linkdin_link }}" class="form-control">
                                                @error('linkdin_link')
                                                    <span class="text-danger" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
